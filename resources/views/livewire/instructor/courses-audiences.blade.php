            ...
            <div class="card-body bg-gray-100">
                @if ($audience->id == $item->id) 
                    <form wire:submit.prevent="update">
                        <x-jet-input wire:model="audience.name" class="w-full shadow-sm" type="text"></x-jet-input>
                        @error('audience.name')
    ...
    <article class="card">
        <div class="card-body bg-gray-100">
            <form wire:submit.prevent="store">
                <x-jet-input wire:model="name" class="w-full shadow-sm" type="text" placeholder="Agregar nombre de la audiencia"></x-jet-input>
