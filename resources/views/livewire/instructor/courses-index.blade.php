<div class="container py-8">
	<x-table-responsive>
		<div class="px-6 py-4 flex">
			<x-jet-input wire:keydown="limpiar_page" wire:model="search" class="flex-1 shadow-sm" placeholder="Buscar curso ..." type="text"></x-jet-input>
							...
							<td class="px-6 py-4 whitespace-nowrap">
								<div class="flex items-center">
									<div class="flex-shrink-0 h-10 w-10">
										...
										@else
											<img class="h-10 w-10 rounded-full object-cover object-center" src="https://images.pexels.com/photos/1181298/pexels-photo-1181298.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260">
										@endisset
									</div>
									<div class="ml-4">
