<section class="mt-8">
    ...
    @can('enrolled', $course)
        <article>
            @can ('valued', $course) 
                <textarea wire:model="comments" class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm " rows="3" placeholder="Ingrese reseña del curso"></textarea>
    ...
    <div class="card mt-8">
        <div class="card-body">
            <p class="text-gray-800 text-xl mb-6">{{ $course->reviews->count() }} Valoraciones</p>
                ...
                <article class="flex mb-4 text-gray-800">
                    ...
                    <div class="card flex-1">
                        <div class="card-body bg-gray-100">
                            <p><b>{{ $review->user->name }}</b><i class="fas fa-star text-yellow-300 mx-2"></i>{{ $review->rating }}</p>
                            {{ $review->comment }}
                        </div>
                    </div>
                </article>
